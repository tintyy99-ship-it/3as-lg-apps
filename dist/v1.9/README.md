# 3AS LG v1.9 — Apps signées (clé upload) + infos signature

## Les apps (install direct / Play Store)
| Fichier | Usage | Taille |
|---|---|---|
| `3AS-LG-Eleve-v1.9.apk` | Install directe téléphone (Élève) | ~262 Ko |
| `3AS-LG-Admin-v1.9.apk` | Install directe téléphone (Admin) | ~193 Ko |
| `3AS-LG-Eleve-v1.9.aab` | Envoi Play Console (Élève) | ~262 Ko |
| `3AS-LG-Admin-v1.9.aab` | Envoi Play Console (Admin) | ~193 Ko |
| `CHECKSUMS.sha256` | Vérifier l'intégrité après téléchargement | — |

Vérification : `sha256sum -c CHECKSUMS.sha256`

Nouveau v1.9 : bouton 🗑️ Supprimer élève dans l'Admin (tableau + chat),
suppression Supabase `students` + `messages`, versionCode 9.
